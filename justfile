...
install-hmt-packager:
    cargo install hmt-packager --git https://github.com/hummanta/hummanta --tag v0.11.33

install-hmt-manifest:
    cargo install hmt-manifest --git https://github.com/hummanta/hummanta --tag v0.11.33
